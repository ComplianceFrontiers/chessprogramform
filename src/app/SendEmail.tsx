  ...
  const handleSendEmail = async () => {
    ...
    <div style="font-family: Arial, sans-serif; color: #333; padding: 20px; text-align: center;">
      ...
      <p style="font-size: 16px; line-height: 1.6; text-align: left; max-width: 800px; margin-left: auto; margin-right: auto;">
        <b style="color: #d72c2c;">Program Details:</b><br />
        <b style="color: #d72c2c;">Dates:</b> Tuesdays, November 19 (TONIGHT) - December 17<br />
        <b style="color: #d72c2c;">Time:</b> 5 - 6:30 PM or 6:30 - 8 PM<br />
        <b style="color: #d72c2c;">Location:</b> Siegel JCC Auditorium<br />
        <b style="color: #d72c2c;">Instructor:</b> Coach Jeffers, Camp Archery Specialist<br />
        <b style="color: #d72c2c;">Age Restrictions:</b> 8+<br />
        <b style="color: #d72c2c;">Cost:</b> $75/Member, $100/Non-Member<br />
      ...
      <div style="background-color: #f1646f; padding: 20px; color: white; text-align: center;">
        <p style="font-size: 16px; line-height: 1.6; text-align: left; max-width: 800px; margin-left: auto; margin-right: auto;">
      ...
      <footer style="background-color: #7fcfff; padding: 20px; font-size: 14px; text-align: center; color: #333;">
        <p>Follow us:</p>
        <p>
